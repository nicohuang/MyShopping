...
import hwz.com.myshopping.page.checkout.pay.DeliveryFragment;
import hwz.com.myshopping.page.checkout.pay.InvoiceFragment;
import hwz.com.myshopping.page.checkout.pay.PayMentActivity;
import hwz.com.myshopping.page.address.AddressListFragment;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        if (view == null)
        {
            ...
            relative_checktype.setOnClickListener(new OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    PayMentActivity payMentFragment = new PayMentActivity();
                    CheckInfo.addressid = 1;
            ...
            btn_checkout.setOnClickListener(new OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    } else
                    {
                        ...
                        final String url = MyUrl.URLHEAD + MyUrl.LOGIN + "username=" + application.username + "&&password=" + application.password;
