		...
		if(view ==null){
			...
			relative1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					CheckInfo.deliveryid=1;
                    CheckInfo.deliverytime="周一至周五送货";
				}
			});
			relative2.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					image3.setVisibility(View.INVISIBLE);
                    CheckInfo.deliveryid=2;
                    CheckInfo.deliverytime="双休日及公众假期送货";
				}
			});
			relative3.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					image2.setVisibility(View.INVISIBLE);
					image1.setVisibility(View.INVISIBLE);
                    CheckInfo.deliveryid=3;
                    CheckInfo.deliverytime="时间不限，工作日双休日及公众假期均可送货";
				}
			});
